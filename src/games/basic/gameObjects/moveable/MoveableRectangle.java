...
public class MoveableRectangle extends AbstractMoveableGameObject implements Runnable{
    ...
    public MoveableRectangle(Positionable pos,Positionable deltaPos, int width, int height, Color colour, boolean isFilled, int strokeSize) {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof MoveableRectangle))
            return false;

        MoveableRectangle otherRect = (MoveableRectangle)other;
